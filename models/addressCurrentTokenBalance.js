...
module.exports = (sequelize, DataTypes) => {
  class AddressCurrentTokenBalance extends Model {
    static associate(models) {

    }
  };
  AddressCurrentTokenBalance.init({
      ...
      old_value: { type: DataTypes.NUMERIC(100,0) },
      created_at: { type: DataTypes.DATE },
      updated_at: { type: DataTypes.DATE },
  }, {
    sequelize,
    tableName: 'address_current_token_balances',
    timestamps: true,
    createdAt: 'created_at',
    updatedAt: 'updated_at',
  });
  return AddressCurrentTokenBalance;
};