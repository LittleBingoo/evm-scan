...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.createTable('block_second_degree_relations', {
      nephew_hash: { type: Sequelize.STRING, allowNull: false, primaryKey: true },
    ...
    await queryInterface.createTable('transaction_forks', {
      index: { type: Sequelize.INTEGER, allowNull: false, primaryKey: true},
      uncle_hash: { type: Sequelize.STRING, allowNull: false },
    ...
    await queryInterface.createTable('token_transfers', {
      transaction_hash: { type: Sequelize.STRING, allowNull: false, primaryKey: true},
